        ...
        methods: {
            fetch() {
                ...
                axios.all([
                    ...
                    this.product = first_response.data.data;
                    ...
                    setTimeout(() => {
                        ...
                        if (that.product.tags.length > 0) {
                            $('input[name=tags]').tagsinput('add', that.post.tags);
                        }
                ...
                switch (target.name) {
                    case 'image':
                        ...
                        reader.onload = function (e) {
                            that.product.image_url = e.target.result;
                        };
            ...
            onSubmit(e) {
                ...
                formData.append('image', this.product.image != undefined ? this.post.image : '');
                formData.append('tags', this.product.tags);
                formData.append('status', this.product.status ? 1 : 0);
                formData.append('_method', 'patch');

                updateProduct(this.product.id, formData).then(({data}) => {
