            ...
            <div class="block-header">
                <div class="row">
                    <ol class="breadcrumb m-b-0 p-b-0">
                        ...
                        <li class="active">Báo cáo Giao dịch nạp tiền</li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="body table-responsive">
                            <table id="reportTable" class="table table-bordered table-hover dataTable">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="2" width="250">Tổng tiền nạp</th>
...
<script>
    ...
    import {getTransactionDepositReports} from '../../models/report'
    import {exportTableToExcel} from '../../utils/excel'

    export default {
        name: "TransactionDepositList",
        title: 'Báo cáo Giao dịch nạp tiền',
        ...
        methods: {
            ...
            updateUrl(page = 1) {
                this.$router.replace({
                    name: 'report_deposit', params: {}, query: {
                        date_from: this.search.date_from,
                        date_to: this.search.date_to
                    }
                }).catch(err => {
            ...
            exportToExcel() {
                // exportTableToExcel('reportTable', 'report-deposit');
