            ...
            <div class="block-header">
                <div class="row">
                    <ol class="breadcrumb m-b-0 p-b-0">
                        ...
                        <li>
                            <router-link :to="{ name: 'get_post_categories' }">
...
<script>
    ...
    import {getPostCategory, updatePostCategory, getPostCategories} from '../../models/post.category'
        ...
        methods: {
            fetch() {
                ...
                axios.all([
                    ...
                    this.category = first_response.data.data.post_category;
            ...
            onSubmit(e) {
                ...
                formData.append('is_active', this.category.is_active ? 1 : 0);
                //formData.append('_method', 'patch');

                updatePostCategory(this.category.id, formData)
                    .then(({data}) => this.$router.push('/post-category'))
